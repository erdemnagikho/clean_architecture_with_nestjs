...
import { ProductFilters, ProductRepository } from "../../../product/application/ports/product.repository.port";
...
import { products } from "../../../shared/infrastructure/database/postgres/schema/product.schema";
...
export class DrizzleProductRepository implements ProductRepository {
    ...
    async findById(id: ProductId): Promise<Product | null> {
        const rows = await this.db.select().from(products).where(eq(products.id, id.getValue()));
